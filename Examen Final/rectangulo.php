...
<body background="img/fondo.jpg">
    ...
    <header>
        <div class="contenedor">
            ...
            <section id="bienvenidos">
                        <div class="contenedor">
                        <br><br><br>
                            <h2>Calcular área de un rectangulo</h2>
                            <BR>
                            ...
                            <font size="+1">
                            <form action="http://localhost/Examen Final/RectanguloF.php" method="POST">
    ...
    <footer>
        ...
        <p><br><font color="white"> 
            <p>Universidad Auntonoma de Chiapas</p>
            <p>Espinoza Dominguez Manuel Antonio
            <p> Estrada Palacios Azucena Concepcion
            <p></font>
        </div>
   </footer>
</body>
